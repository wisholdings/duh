...
# --- SouthwestRatioCalculator Class Definition ---
class SouthwestRatioCalculator:
    def __init__(self, base_dir: str = BASE_OUTPUT_DIR):
        """
        Initialize the SouthwestRatioCalculator.
    ...
    def _get_ratio_configs(self) -> List[Dict[str, Any]]:
        ...
        configs = [
            ...
            {
                "mw_col": "SOUTHWEST_NG_MW",
                "capacity_col": "Southwest_Total_Capacity_Naturalgas",
                "ratio_col": "SOUTHWEST_NG_RATIO",
                "label": "Natural Gas",
                "min_ratio": 0.0,
                "max_ratio": 1.0,
                "category": "base_load"
            ...
            {
                "mw_col": "SOUTHWEST_COL_MW",
                "capacity_col": "Southwest_Total_Capacity_Coal",
                "ratio_col": "SOUTHWEST_COAL_RATIO",
                "label": "Coal",
                "min_ratio": 0.0,
                "max_ratio": 1.0,
                "category": "base_load"
            ...
            {
                "mw_col": "SOUTHWEST_NUC_MW",
                "capacity_col": "Southwest_Total_Capacity_Nuclear",
                "ratio_col": "SOUTHWEST_NUCLEAR_RATIO",
                "label": "Nuclear",
                "min_ratio": 0.0,
                "max_ratio": 1.0,
                "category": "base_load"
            ...
            {
                "mw_col": "SOUTHWEST_SUN_MW",
                "capacity_col": "Southwest_Total_Capacity_Solar",
                "ratio_col": "SOUTHWEST_SOLAR_RATIO",
                "label": "Solar",
                "min_ratio": 0.0,
                "max_ratio": 1.0,
                "category": "renewable"
            ...
            {
                "mw_col": "SOUTHWEST_WND_MW",
                "capacity_col": "Southwest_Total_Capacity_Wind",
                "ratio_col": "SOUTHWEST_WIND_RATIO",
                "label": "Wind",
                "min_ratio": 0.0,
                "max_ratio": 1.0,
                "category": "renewable"
            ...
            {
                "mw_col": "SOUTHWEST_WAT_MW",
                "capacity_col": "Southwest_Total_Capacity_Hydroelectric",
                "ratio_col": "SOUTHWEST_HYDRO_RATIO",
                "label": "Hydro",
                "min_ratio": 0.0,
                "max_ratio": 1.0,
                "category": "renewable"
            ...
            {
                "mw_col": "SOUTHWEST_OTH_MW",
                "capacity_col": "Southwest_Total_Capacity_Other",
                "ratio_col": "SOUTHWEST_OTH_RATIO",
                "label": "Other",
                "min_ratio": -1.0,
                "max_ratio": 1.0,
                "category": "other"
            ...
            {
                "mw_col": "SOUTHWEST_BAT_MW",
                "capacity_col": "Southwest_Total_Capacity_Batteries",
                "ratio_col": "SOUTHWEST_BATTERIES_RATIO",
                "label": "Batteries",
                "min_ratio": -1.0,
                "max_ratio": 1.0,
                "category": "storage"
            ...
            {
                "mw_col": "SOUTHWEST_INTERCHANGE_MW",
                "capacity_col": None,  # No capacity column - self-scaled
                "ratio_col": "SOUTHWEST_INTERCHANGE_RATIO",
                "label": "Interchange",
                "min_ratio": -1.0,
                "max_ratio": 1.0,
    ...
    def run(self):
        """Execute the Southwest ratio calculation process."""
        print(f"\n--- Starting Southwest Capacity Ratio Calculations ---")
        df: Optional[pd.DataFrame] = None
        ...
        try:
            ...
            if save_successful:
                print(f"\n--- Southwest ratio calculations completed successfully ---")
            ...
            if 'df_with_ratios' in locals() and df_with_ratios is not None:
                del df_with_ratios
            gc.collect()
            print(f"\n--- Southwest Ratio Calculator finished ---")

# --- Main Execution Block ---
if __name__ == "__main__":
    print("===== Starting Southwest Capacity Ratio Calculation Process =====")
    print(f"Input file: Southwest_complete_wrangled.parquet")
    print(f"Output file: Southwest_complete_with_ratios.parquet")
    print(f"Using Base Output Directory: {BASE_OUTPUT_DIR}")

    calculator: Optional[SouthwestRatioCalculator] = None

    try:
        # Instantiate the calculator
        calculator = SouthwestRatioCalculator(base_dir=BASE_OUTPUT_DIR)
        
        # Execute the ratio calculation process
        calculator.run()

    except ValueError as e:
        print(f"Southwest Ratio Calculator (Config/Init Error): {e}")
        traceback.print_exc()
    except Exception as e:
        print(f"Southwest Ratio Calculator (Critical Error): {e}")
        traceback.print_exc()
    finally:
    ...
    print("\n" + "="*60)
    print("--- Southwest Capacity Ratio Calculation Complete ---")
    print("="*60)