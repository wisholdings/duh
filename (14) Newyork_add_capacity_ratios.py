...
# --- NewyorkRatioCalculator Class Definition ---
class NewyorkRatioCalculator:
    def __init__(self, base_dir: str = BASE_OUTPUT_DIR):
        """
        Initialize the NewyorkRatioCalculator.
    ...
    def _get_ratio_configs(self) -> List[Dict[str, Any]]:
        ...
        configs = [
            ...
            {
                "mw_col": "NEWYORK_NG_MW",
                "capacity_col": "Newyork_Total_Capacity_Naturalgas",
                "ratio_col": "NEWYORK_NG_RATIO",
                "label": "Natural Gas",
                "min_ratio": 0.0,
                "max_ratio": 1.0,
                "category": "base_load"
            ...
            {
                "mw_col": "NEWYORK_COL_MW",
                "capacity_col": "Newyork_Total_Capacity_Coal",
                "ratio_col": "NEWYORK_COAL_RATIO",
                "label": "Coal",
                "min_ratio": 0.0,
                "max_ratio": 1.0,
                "category": "base_load"
            ...
            {
                "mw_col": "NEWYORK_NUC_MW",
                "capacity_col": "Newyork_Total_Capacity_Nuclear",
                "ratio_col": "NEWYORK_NUCLEAR_RATIO",
                "label": "Nuclear",
                "min_ratio": 0.0,
                "max_ratio": 1.0,
                "category": "base_load"
            ...
            {
                "mw_col": "NEWYORK_WND_MW",
                "capacity_col": "Newyork_Total_Capacity_Wind",
                "ratio_col": "NEWYORK_WIND_RATIO",
                "label": "Wind",
                "min_ratio": 0.0,
                "max_ratio": 1.0,
                "category": "renewable"
            ...
            {
                "mw_col": "NEWYORK_WAT_MW",
                "capacity_col": "Newyork_Total_Capacity_Hydroelectric",
                "ratio_col": "NEWYORK_HYDRO_RATIO",
                "label": "Hydro",
                "min_ratio": 0.0,
                "max_ratio": 1.0,
                "category": "renewable"
            ...
            {
                "mw_col": "NEWYORK_OTH_MW",
                "capacity_col": "Newyork_Total_Capacity_Other",
                "ratio_col": "NEWYORK_OTH_RATIO",
                "label": "Other",
                "min_ratio": -1.0,
                "max_ratio": 1.0,
                "category": "other"
            ...
            #             {
            #     "mw_col": "NEWYORK_PS_MW",
            #     "capacity_col": "Newyork_Total_Capacity_Pumped_Storage",
            #     "ratio_col": "NEWYORK_PS_RATIO",
            #     "label": "Batteries",
            #     "min_ratio": -1.0,
            #     "max_ratio": 1.0,
            #     "category": "storage"
            ...
            # {
            #     "mw_col": "NEWYORK_BATTERIES_MW",
            #     "capacity_col": "Newyork_Total_Capacity_Batteries",
            #     "ratio_col": "NEWYORK_BATTERIES_RATIO",
            #     "label": "Batteries",
            #     "min_ratio": -1.0,
            #     "max_ratio": 1.0,
            #     "category": "storage"
            ...
            {
                "mw_col": "NEWYORK_INTERCHANGE_MW",
                "capacity_col": None,  # No capacity column - self-scaled
                "ratio_col": "NEWYORK_INTERCHANGE_RATIO",
                "label": "Interchange",
                "min_ratio": -1.0,
                "max_ratio": 1.0,
    ...
    def run(self):
        """Execute the Newyork ratio calculation process."""
        print(f"\n--- Starting Newyork Capacity Ratio Calculations ---")
        df: Optional[pd.DataFrame] = None
        ...
        try:
            ...
            if save_successful:
                print(f"\n--- Newyork ratio calculations completed successfully ---")
            ...
            if 'df_with_ratios' in locals() and df_with_ratios is not None:
                del df_with_ratios
            gc.collect()
            print(f"\n--- Newyork Ratio Calculator finished ---")

# --- Main Execution Block ---
if __name__ == "__main__":
    print("===== Starting Newyork Capacity Ratio Calculation Process =====")
    print(f"Input file: Newyork_complete_wrangled.parquet")
    print(f"Output file: Newyork_complete_with_ratios.parquet")
    print(f"Using Base Output Directory: {BASE_OUTPUT_DIR}")

    calculator: Optional[NewyorkRatioCalculator] = None

    try:
        # Instantiate the calculator
        calculator = NewyorkRatioCalculator(base_dir=BASE_OUTPUT_DIR)
        
        # Execute the ratio calculation process
        calculator.run()

    except ValueError as e:
        print(f"Newyork Ratio Calculator (Config/Init Error): {e}")
        traceback.print_exc()
    except Exception as e:
        print(f"Newyork Ratio Calculator (Critical Error): {e}")
        traceback.print_exc()
    finally:
    ...
    print("\n" + "="*60)
    print("--- Newyork Capacity Ratio Calculation Complete ---")
    print("="*60)