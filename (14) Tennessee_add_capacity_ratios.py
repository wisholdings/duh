...
# --- TennesseeRatioCalculator Class Definition ---
class TennesseeRatioCalculator:
    def __init__(self, base_dir: str = BASE_OUTPUT_DIR):
        """
        Initialize the TennesseeRatioCalculator.
    ...
    def _get_ratio_configs(self) -> List[Dict[str, Any]]:
        ...
        configs = [
            ...
            {
                "mw_col": "TENNESSEE_NG_MW",
                "capacity_col": "Tennessee_Total_Capacity_Naturalgas",
                "ratio_col": "TENNESSEE_NG_RATIO",
                "label": "Natural Gas",
                "min_ratio": 0.0,
                "max_ratio": 1.0,
                "category": "base_load"
            ...
            {
                "mw_col": "TENNESSEE_COL_MW",
                "capacity_col": "Tennessee_Total_Capacity_Coal",
                "ratio_col": "TENNESSEE_COAL_RATIO",
                "label": "Coal",
                "min_ratio": 0.0,
                "max_ratio": 1.0,
                "category": "base_load"
            ...
            {
                "mw_col": "TENNESSEE_NUC_MW",
                "capacity_col": "Tennessee_Total_Capacity_Nuclear",
                "ratio_col": "TENNESSEE_NUCLEAR_RATIO",
                "label": "Nuclear",
                "min_ratio": 0.0,
                "max_ratio": 1.0,
                "category": "base_load"
            ...
            {
                "mw_col": "TENNESSEE_SUN_MW",
                "capacity_col": "Tennessee_Total_Capacity_Solar",
                "ratio_col": "TENNESSEE_SOLAR_RATIO",
                "label": "Solar",
                "min_ratio": -1.0,
                "max_ratio": 1.0,
                "category": "renewable"
            ...
            {
                "mw_col": "TENNESSEE_WAT_MW",
                "capacity_col": "Tennessee_Total_Capacity_Hydroelectric",
                "ratio_col": "TENNESSEE_HYDRO_RATIO",
                "label": "Hydro",
                "min_ratio": 0.0,
                "max_ratio": 1.0,
                "category": "renewable"
            ...
            {
                "mw_col": "TENNESSEE_OTH_MW",
                "capacity_col": "Tennessee_Total_Capacity_Other",
                "ratio_col": "TENNESSEE_OTH_RATIO",
                "label": "Other",
                "min_ratio": -1.0,
                "max_ratio": 1.0,
                "category": "other"
            ...
            {
                "mw_col": "TENNESSEE_PS_MW",
                "capacity_col": "Tennessee_Total_Capacity_Pumped_Storage",
                "ratio_col": "TENNESSEE_PS_RATIO",
                "label": "Batteries",
                "min_ratio": -1.0,
                "max_ratio": 1.0,
                "category": "storage"
            ...
            {
                "mw_col": "TENNESSEE_INTERCHANGE_MW",
                "capacity_col": None,  # No capacity column - self-scaled
                "ratio_col": "TENNESSEE_INTERCHANGE_RATIO",
                "label": "Interchange",
                "min_ratio": -1.0,
                "max_ratio": 1.0,
    ...
    def run(self):
        """Execute the Tennessee ratio calculation process."""
        print(f"\n--- Starting Tennessee Capacity Ratio Calculations ---")
        df: Optional[pd.DataFrame] = None
        ...
        try:
            ...
            if save_successful:
                print(f"\n--- Tennessee ratio calculations completed successfully ---")
            ...
            if 'df_with_ratios' in locals() and df_with_ratios is not None:
                del df_with_ratios
            gc.collect()
            print(f"\n--- Tennessee Ratio Calculator finished ---")

# --- Main Execution Block ---
if __name__ == "__main__":
    print("===== Starting Tennessee Capacity Ratio Calculation Process =====")
    print(f"Input file: Tennessee_complete_wrangled.parquet")
    print(f"Output file: Tennessee_complete_with_ratios.parquet")
    print(f"Using Base Output Directory: {BASE_OUTPUT_DIR}")

    calculator: Optional[TennesseeRatioCalculator] = None

    try:
        # Instantiate the calculator
        calculator = TennesseeRatioCalculator(base_dir=BASE_OUTPUT_DIR)
        
        # Execute the ratio calculation process
        calculator.run()

    except ValueError as e:
        print(f"Tennessee Ratio Calculator (Config/Init Error): {e}")
        traceback.print_exc()
    except Exception as e:
        print(f"Tennessee Ratio Calculator (Critical Error): {e}")
        traceback.print_exc()
    finally:
    ...
    print("\n" + "="*60)
    print("--- Tennessee Capacity Ratio Calculation Complete ---")
    print("="*60)