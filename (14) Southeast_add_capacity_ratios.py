...
# --- SoutheastRatioCalculator Class Definition ---
class SoutheastRatioCalculator:
    def __init__(self, base_dir: str = BASE_OUTPUT_DIR):
        """
        Initialize the SoutheastRatioCalculator.
    ...
    def _get_ratio_configs(self) -> List[Dict[str, Any]]:
        ...
        configs = [
            ...
            {
                "mw_col": "SOUTHEAST_NG_MW",
                "capacity_col": "Southeast_Total_Capacity_Naturalgas",
                "ratio_col": "SOUTHEAST_NG_RATIO",
                "label": "Natural Gas",
                "min_ratio": 0.0,
                "max_ratio": 1.0,
                "category": "base_load"
            ...
            {
                "mw_col": "SOUTHEAST_COL_MW",
                "capacity_col": "Southeast_Total_Capacity_Coal",
                "ratio_col": "SOUTHEAST_COAL_RATIO",
                "label": "Coal",
                "min_ratio": 0.0,
                "max_ratio": 1.0,
                "category": "base_load"
            ...
            {
                "mw_col": "SOUTHEAST_NUC_MW",
                "capacity_col": "Southeast_Total_Capacity_Nuclear",
                "ratio_col": "SOUTHEAST_NUCLEAR_RATIO",
                "label": "Nuclear",
                "min_ratio": 0.0,
                "max_ratio": 1.0,
                "category": "base_load"
            ...
            {
                "mw_col": "SOUTHEAST_SUN_MW",
                "capacity_col": "Southeast_Total_Capacity_Solar",
                "ratio_col": "SOUTHEAST_SOLAR_RATIO",
                "label": "Solar",
                "min_ratio": 0.0,
                "max_ratio": 1.0,
                "category": "renewable"
            ...
            {
                "mw_col": "SOUTHEAST_WAT_MW",
                "capacity_col": "Southeast_Total_Capacity_Hydroelectric",
                "ratio_col": "SOUTHEAST_HYDRO_RATIO",
                "label": "Hydro",
                "min_ratio": 0.0,
                "max_ratio": 1.0,
                "category": "renewable"
            ...
            {
                "mw_col": "SOUTHEAST_OTH_MW",
                "capacity_col": "Southeast_Total_Capacity_Other",
                "ratio_col": "SOUTHEAST_OTH_RATIO",
                "label": "Other",
                "min_ratio": -1.0,
                "max_ratio": 1.0,
                "category": "other"
            ...
            # # Battery/Storage [-1,1] (can charge/discharge)
                        {
                "mw_col": "SOUTHEAST_BAT_MW",
                "capacity_col": "Southeast_Total_Capacity_Batteries",
                "ratio_col": "SOUTHEAST_BATTERIES_RATIO",
                "label": "Batteries",
                "min_ratio": -1.0,
                "max_ratio": 1.0,
                "category": "storage"
            ...
            {
                "mw_col": "SOUTHEAST_INTERCHANGE_MW",
                "capacity_col": None,  # No capacity column - self-scaled
                "ratio_col": "SOUTHEAST_INTERCHANGE_RATIO",
                "label": "Interchange",
                "min_ratio": -1.0,
                "max_ratio": 1.0,
    ...
    def run(self):
        """Execute the Southeast ratio calculation process."""
        print(f"\n--- Starting Southeast Capacity Ratio Calculations ---")
        df: Optional[pd.DataFrame] = None
        ...
        try:
            ...
            if save_successful:
                print(f"\n--- Southeast ratio calculations completed successfully ---")
            ...
            if 'df_with_ratios' in locals() and df_with_ratios is not None:
                del df_with_ratios
            gc.collect()
            print(f"\n--- Southeast Ratio Calculator finished ---")

# --- Main Execution Block ---
if __name__ == "__main__":
    print("===== Starting Southeast Capacity Ratio Calculation Process =====")
    print(f"Input file: Southeast_complete_wrangled.parquet")
    print(f"Output file: Southeast_complete_with_ratios.parquet")
    print(f"Using Base Output Directory: {BASE_OUTPUT_DIR}")

    calculator: Optional[SoutheastRatioCalculator] = None

    try:
        # Instantiate the calculator
        calculator = SoutheastRatioCalculator(base_dir=BASE_OUTPUT_DIR)
        
        # Execute the ratio calculation process
        calculator.run()

    except ValueError as e:
        print(f"Southeast Ratio Calculator (Config/Init Error): {e}")
        traceback.print_exc()
    except Exception as e:
        print(f"Southeast Ratio Calculator (Critical Error): {e}")
        traceback.print_exc()
    finally:
    ...
    print("\n" + "="*60)
    print("--- Southeast Capacity Ratio Calculation Complete ---")
    print("="*60)